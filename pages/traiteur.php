    ...
    <div class="formules-section">
        ...
        <div class="formule-block">
            <div class="formule-content-wrapper">
                <div class="formule-header-block">
                    ...
                    <p class="formule-subtitle">À partir de 12 personnes</p>
                </div>

                <ul class="formule-list">
                    <li>6 pièces cocktails salées</li>
                    <li>3 timbalines (chaudes ou froides)</li>
                    <li>1 timbalines sucrées ou 4 mignardises</li>
                </ul>
                <p class="formule-note">(Quantité pour 1 personne)</p>
            </div>

            <div class="formule-footer-block">
                <div class="formule-price-box">
                    <p class="price-label">À partir de</p>
                    <p class="price-amount">50€ / pers.</p>
                </div>
                <a href="?page=details&category=classique" class="btn-details">Plus de détails</a>
            </div>
        </div>
        ...
        <div class="formule-block">
            <div class="formule-content-wrapper">
                ...
                <ul class="formule-list">
                    <li>10 pièces cocktails salées</li>
                    <li>3 timbalines (chaudes ou froides)</li>
                    <li>1 timbalines sucrées ou 4 mignardises</li>
                </ul>
                <p class="formule-note">(Quantité pour 1 personne)</p>
            ...
            <div class="formule-footer-block">
                <div class="formule-price-box">
                    <p class="price-label">À partir de</p>
                    <p class="price-amount">60€ / pers.</p>
                </div>
                <a href="?page=details&category=premium" class="btn-details">Plus de détails</a>
            </div>
        </div>
        ...
        <div class="formule-block">
            <div class="formule-content-wrapper">
                ...
                <ul class="formule-list">
                    <li>12 pièces cocktails salées</li>
                    <li>4 timbalines (chaudes ou froides)</li>
                    <li>2 timbalines sucrées ou 6 mignardises</li>
                </ul>
                <p class="formule-note">(Quantité pour 1 personne)</p>
            </div>
            ...
            <div class="formule-footer-block">
                <div class="formule-price-box">
                    <p class="price-label">À partir de</p>
                    <p class="price-amount">75€ / pers.</p>
                </div>
                <a href="?page=details&category=prestige" class="btn-details">Plus de détails</a>
            </div>
        </div>
