...
<form method="POST" id="bookingForm" onsubmit="return handleSubmit(event)">
    <section class="supplements-page">
        ...
        <div class="supplements-section">
            <h2 class="section-main-title">3. Suppléments</h2>
                ...
                <div class="supplement-card" data-name="Serveur" data-price="160">
                    <div class="supplement-header">
                        <div class="supplement-info">
                            ...
                            <p class="supplement-desc">1 servidor por 10 pers. 4h sur site.</p>
                        </div>
        ...
        <!-- Services (just for show, not in total) -->
        <div class="services-section">
            <h2 class="section-main-title">4. Services additionnels</h2>
        ...
        <div class="date-time-section">
            <h2 class="section-main-title">5. Choix de la date et heure</h2>
        ...
        <div class="contact-section">
            <h2 class="section-main-title">6. Informations de contact</h2>
...
<style>
    ...
    * {
    ...
    /* ==============================
       IMPROVED QUANTITY CONTROLS WITH ARROWS (CORRECT ORDER)
       ============================== */
    .supplement-controls {
        display: flex;
        flex-direction: column;
    ...
    /* ==============================
       IMPROVED DATE & TIME PICKER WITH ARROWS
       ============================== */
    .date-time-section p {
        font-size: 0.94rem;
        color: var(--text-secondary);
        ...
        document.querySelectorAll('.supplement-card').forEach(card => {
            ...
            if (qty > 0) {
                supplements.push({
                    ...
                    qty: qty,
                    price_per_unit: parseInt(card.dataset.price),
                    total: qty * parseInt(card.dataset.price)
                });
            }
        });
